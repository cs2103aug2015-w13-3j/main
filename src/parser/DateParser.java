...
public class DateParser {
	...
	private static final int FORMAT_TYPE_0_INDEX = 6; // format 0 : full date,
														// with year
	private static final int FORMAT_TYPE_1_INDEX = 11; // format 1 : with day
														// and month only
	private static final int FORMAT_TYPE_2_INDEX = 12; // format 2 : day of the
														// week, Friday, etc.
	private static final int FORMAT_TYPE_3_INDEX = 20; // format 3 : just day,
														// month, year
