...
public class SetPathTest {
	...
	public void test() {
		...
		Storage.getInstance().setPath("TaskBomber.txt");
		System.out.println(a);
		System.out.println(Storage.getInstance().read());
		assertEquals(Storage.getInstance().read().get(2).getName(), a.get(2).getName());
